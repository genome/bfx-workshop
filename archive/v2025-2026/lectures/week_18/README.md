...
- [Lecture Recording](https://wustl.box.com/s/1glimd6zmchach6e1yexpuxdwcct5853)

- [Lecture Slides](BFXworkshop2026scRNADay1.pdf)
...
In the [Rmarkdown homework file](BFXworkshop_2026scRNA_Day1.Rmd), play around with the different parameters. Variables to modify are in the top portion and described within the Rmarkdown. Make sure to update the working directory to point to the correct path on your computer. Once you set the analysis parameters, click 'Knit' in RStudio to run the code. It will take about 5 minutes to run.  
