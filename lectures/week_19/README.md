...
To run the day 2 [Rmarkdown homework file](BFXworkshop_2026scRNA_Day2.Rmd), you will use the same dataset as last week- see [last week's instructions](../week_18/README.md). Make sure to install the 3 new packages listed above.
